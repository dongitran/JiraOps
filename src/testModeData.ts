...
export function resolveTestNotificationIssues(): JiraAssignedIssue[] {
  return [
    ...resolveTestAssignedIssues(),
    {
      ...
      reporterDisplayName: 'Incident Bot',
